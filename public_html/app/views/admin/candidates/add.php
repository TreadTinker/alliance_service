<?php
// Переменные: $departments, $cities, $errors, $success
?>
<style>
    .form-container {
        max-width: 600px;
...
<div class="admin-header">
    <div class="admin-header-content">
        <h1>Добавление курьера</h1>
        <p>Заполните информацию о новом курьере</p>
    </div>
</div>
            ...
            <form method="POST">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="courier_id" name="courier_id" required
                            value="<?= htmlspecialchars($_POST['courier_id'] ?? '') ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <select id="status" name="status">
                        ...
                        <option value="inactive" <?= ($_POST['status'] ?? '') === 'inactive' ? 'selected' : '' ?>>Неактивен</option>
                    </select>
                </div>
